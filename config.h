...
const char *spcmd3[] = {TERMINAL, "-n", "spcalendar", "-g", "120x34", "-e", "calcurse", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,      "spcalendar",NULL,       	    SPTAG(2),     1,           1,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_y,		spawn,	SHCMD("ytp") }, /* spiral */
	...
	{ MODKEY,			XK_F2,		spawn,		SHCMD("brave 'https://johnstef.duckdns.org'") },
	...
	{ MODKEY,			XK_F11,		spawn,		SHCMD("ffplay /dev/video1 -fflags nobuffer") },
